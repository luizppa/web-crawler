...
namespace search_engine {
    ...
    class Search {
        ...
        private:
            ...
            static std::map<std::string, int> vocabulary_index;
            static nlohmann::json rank_weights;

            static std::string file_binary_search(std::string search_term, char const* file_path);
            ...
            static std::pair<std::string, std::string> search_document_briefing(int id, char const* briefing_file_path);
            static IndexCell* search_index_entry(std::string word, char const* index_path);
            static double document_relevance(std::map<std::string, IndexCell*>* query_params, std::string query, int document_id, std::string url);
            ...
            static float get_page_weight(std::string page);

        public:
            static void init_vocabulary(char const* vocabulary_path);
            static void init_collection(char const* collection_path);
